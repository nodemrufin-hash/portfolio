 ...
 const project = [
    {
        ...
        description:"A beautiful and functional modern shoe store ",
    ...
    },
     {
        id: 2,
        title: "Libéo ",
        description:"A simulated digital bank, built from A to Z. From Design,planning,development and deployment with user authentification",
    ...
    <section id="projects" className="py-24 px-4 relative">
        <div className="container mx-auto max-w-5xl">
            ...
            <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
               ...
               crafted with attension to detail, performace, and user experience.
            </p>
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3  gap-8 ">
               {project.map((project, key) => (
                    ...
                    <div className="px-6 pt-6 pb-2 flex flex-col flex-1">
             ...
             <div className="text-center mt-12">
                ...
                target="_blank"
                href="https://github.com/nodemrufin-hash">
                    Check My GitHub <ArrowRight size={16} className="animate-bounce-horizontal"/>
                </a>
